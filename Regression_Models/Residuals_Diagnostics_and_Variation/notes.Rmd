...
#### Perhaps the simplest leave-one-out 
...
Since linear algebra should be avoided, perhaps hat values should be glossed, and the mean-shift derivation of Studentized residuals should be illustrated.
