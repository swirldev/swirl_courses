...
# arg2 represent the arguments of your function. You can manipulate the
# arguments you specify within the function. After sourcing the function, you
# can use the function by typing:
# 
